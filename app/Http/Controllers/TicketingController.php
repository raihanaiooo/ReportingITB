...
class TicketingController extends Controller
{
    ...
    public function Bar($numMonths)
    {
        ...
        $labels = array_slice($months, -min($numMonths, count($months)));
        $dataClosed = [];
        $dataResolved = [];
        ...
        foreach ($datas as $item) {
            ...
            $dateTime = Carbon::createFromFormat('M d, Y h:i A', $item->created_time);
    ...
    public function getDate($months)
    {
        $data = $this->Bar($months);
